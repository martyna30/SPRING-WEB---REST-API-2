...
public class TrelloMapper {
    ...
    public List<TrelloBoard> mapToBoard(final List<TrelloBoardDto> trelloBoardDto) {
        return trelloBoardDto.stream()
            ...
            .collect(toList());//return new TrelloBoard(trelloBoardDto.getId)
    }
    ...
    public TrelloCardDto mapToCartDto(final TrelloCard trelloCard) {
        return new TrelloCardDto(trelloCard.getListId(), trelloCard.getName(),trelloCard.getDescription(), trelloCard.getPos());
    }

    public TrelloCard mapToCart(final TrelloCardDto trelloCardDto) {
