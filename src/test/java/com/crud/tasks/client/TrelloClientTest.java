...
public class TrelloClientTest {
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        //When
        CreatedTrelloCardDto newCard = trelloClient.createNewCard(trelloCardDto);//obiekt, który będzie przechowywał dane niezbędne do dodania zadania w Trello.TrelloCardDto:
